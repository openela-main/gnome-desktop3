...
* Thu Apr 30 2026 Joan Torres Lopez <joantolo@redhat.com> - 44.1-5
- Sync gnome-qr library patch series with upstream MR

* Thu Apr 30 2026 Joan Torres Lopez <joantolo@redhat.com> - 44.1-4
- Get qrcodegen tar file from lookaside cache

* Mon Jan 19 2026 Joan Torres Lopez <joantolo@redhat.com> - 44.1-3
- tests submodule needs explicit Requires

* Wed Jan 14 2026 Joan Torres Lopez <joantolo@redhat.com> - 44.1-2
- Add gnome-qr library used by passwordless GDM

* Fri Apr 18 2025 nmontero <nmontero@redhat.com> - 44.1-1
- Update to 44.1

* Fri Mar 14 2025 Michael Catanzaro <mcatanzaro@redhat.com> - 44.0-18
- Drop live user mode patchset

* Tue Oct 29 2024 Troy Dawson <tdawson@redhat.com> - 44.0-17
- Bump release for October 2024 mass rebuild:

* Wed Jul 10 2024 Tomas Popela <tpopela@redhat.com> - 44.0-16
- Convert subpackages to SPDX license format

* Wed Jul 10 2024 Tomas Popela <tpopela@redhat.com> - 44.0-15
- Fix license tag so its validated by license-validate

* Tue Jun 25 2024 Tomas Pelka <tpelka@redhat.com> - 44.0-14
- Add gating.yaml via API

* Mon Jun 24 2024 Troy Dawson <tdawson@redhat.com> - 44.0-13
